...
\begin{figure*}
  \centering
       \includegraphics[width=0.865\textwidth]{../img/batch-delete-features.png}
         \caption{}
...
\begin{figure*}
  \centering
       \includegraphics[width=0.865\textwidth]{../img/batch-triple-deletion.png}
         \caption{}
...
\begin{figure*}
  \centering
       \includegraphics[width=0.865\textwidth]{../img/batch-quintuple-deletion.png}
         \caption{}
...
\begin{figure*}
  \centering
       \includegraphics[width=0.865\textwidth]{../img/batch-vs-sci.png}
         \caption{}
  \label{fig:vs-sci}
\end{figure*}
