...
for i = 1:length(groups)
    ...
    % Draw median
    plotFunc([i-boxWidth/2, i+boxWidth/2], ...
    ...
    plotFunc([i-boxWidth/5, i+boxWidth/5], ...
    ...
    % Draw top whiskers
    plotFunc([i, i], [new_data{i,1}(closest_point), imp_quantiles(3)],...
    ...
    plotFunc([i, i], [new_data{i,1}(closest_point), imp_quantiles(1)],...
        'LineStyle', parsed.WhiskerLineStyle, ...
        'Color', parsed.WhiskerColor,...
        'LineWidth', parsed.WhiskerLineWidth);
    end
    ...
    if parsed.LadderLines && mod(i,2)==0
        ...
        ladderColor(4) = 0.2;
        plotFunc([new_data{i-1,2}'; new_data{i,2}'], [new_data{i-1,1}'; new_data{i,1}'], 'Color', ladderColor);
    end
end
