...
function [X, covr, verrs, cerrs, algs] = missmiss(iters, fixedSeed, displayPlot, includeCheats)
	...
	algs = [algs; struct('func', @fillPCAIter, 'name', 'iPCA', 'args', struct('k', 6, 'VariableWeights', 'variance', 'handleNaN', 'mean', 'iterations', 20, 'algorithm', 'eig'))];
	...
	algs = [algs; struct('func', @fillAutoIter, 'name', 'iAE5', 'args', struct('nh', 6, 'trainMissingRows', true, 'handleNaN', 'mean', 'iterations', 20))];
